package com.kaiokm.kaiokmdevops.business;



import com.kaiokm.kaiokmdevops.api.converter.UsuarioConverter;
import com.kaiokm.kaiokmdevops.api.converter.UsuarioMapper;
import com.kaiokm.kaiokmdevops.api.request.UsuarioRequestDTO;
...
import com.kaiokm.kaiokmdevops.infrastructure.exception.BusinessException;
import com.kaiokm.kaiokmdevops.infrastructure.repository.UsuarioRepository;
...
public class UsuarioService {
    ...
    public UsuarioResponseDTO gravarUsuarios(UsuarioRequestDTO usuarioRequestDTO) {
        try {
            ...
            EnderecoEntity enderecoEntity = enderecoService.salvaEndereco(usuarioConverter.paraEnderecoEntity(usuarioRequestDTO.getEndereco(), usuarioEntity.getId()));
